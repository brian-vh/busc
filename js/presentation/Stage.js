...
//console.log("changeDone this:",this);
//console.log("changeDone current_slide0:",current_slide);
//console.log("changeDone next_slide0:",next_slide);
        var current_slide = this.get('current_slide');
        var next_slide = this.get('next_slide');
        
//console.log("changeDone current_slide1:",current_slide);
//console.log("changeDone next_slide1:",next_slide);

        this.set('current_slide', next_slide);
        this.set('next_slide', null);
//console.log("changeDone this.get('current_slide2'):",this.get('current_slide'));
//console.log("changeDone this.get('next_slide2'):",this.get('next_slide'));
        ...
        // slide did change
//console.log("---changeDone to slide_did_change---");
        this.trigger('slide_did_change', {
            'current_slide': current_slide,
            'next_slide': next_slide
        });
//console.log("changeDone current_slide2:",current_slide);
//console.log("changeDone next_slide2:",next_slide);
    },
